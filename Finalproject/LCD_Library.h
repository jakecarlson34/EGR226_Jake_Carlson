...
#define EN_SEL1  P5SEL1
#define RS_SEL1  P5SEL1
#define RW_SEL1  P5SEL1
#define D4_SEL1  P1SEL1
#define D5_SEL1  P2SEL1
#define D6_SEL1  P1SEL1
#define D7_SEL1  P6SEL1

// SEL0 registers (modify as needed)
#define EN_SEL0  P5SEL0
#define RS_SEL0  P5SEL0
#define RW_SEL0  P5SEL0
#define D4_SEL0  P1SEL0
#define D5_SEL0  P2SEL0
#define D6_SEL0  P1SEL0
#define D7_SEL0  P6SEL0
